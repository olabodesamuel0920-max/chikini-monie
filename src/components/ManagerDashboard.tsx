      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-20">
        ...
        <div className="glass-premium rounded-[3.5rem] border border-white/5 p-12 shadow-2xl">
          ...
          <div className="mt-16 p-6 bg-white/5 rounded-3xl border border-white/5 font-body">
            ...
            <p className="text-[11px] text-gray-500 leading-relaxed font-medium italic">South Gate branch continues to dominate the morning peak hours, contributing to over 40% of daily digital revenue.</p>
          </div>
        </div>
      </div>
