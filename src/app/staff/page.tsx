...
import { getOrders, Order, OrderStatus, loadSampleOrders, resetOrders } from "@/lib/order-utils";
import { Search, Filter, RefreshCw, Trash2, Database, LayoutDashboard } from "lucide-react";
        ...
        <main className="max-w-7xl mx-auto px-4 pt-32 pb-24">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-xs font-bold text-primary uppercase tracking-widest">Preview System</span>
              </div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button
                onClick={fetchOrders}
                className={`p-3 bg-primary rounded-xl text-white shadow-lg shadow-primary/20 ${isRefreshing ? "animate-spin" : ""}`}
              >
          ...
          {filteredOrders.length === 0 ? (
            <div className="text-center py-32 glass rounded-[3rem] border border-dashed border-white/10">
              ...
              <p className="text-gray-500 mb-8">Try clearing filters or load sample data to see the dashboard in action.</p>
              <button
                onClick={handleLoadSample}
                className="premium-gradient px-8 py-4 rounded-2xl font-bold text-white shadow-xl shadow-primary/20"
              >
                Load Sample Day
              </button>
            </div>
